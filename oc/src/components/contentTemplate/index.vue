            ...
            <ul class="con_list" v-if="template.length">
                ...
                <li  class="con_item con_items clearfix" v-for="item in template" :key="item.id">
                    ...
                    <span class="item_operate">
                        ...
                        <span @click="user(item.id)">使用</span>
                        <span>
                             <Poptip
                                placement='bottom'  
                                confirm
                        ...
                        <!-- <span @click="removeNewsTemplate(item.id)">删除</span> -->
                    </span>
                </li>
            </ul>
             <Spin style="height:48px;padding-top:16px" v-show="Loading">
...
export default {
    ...
    methods:{
        ...
        getNewsTemplate(){
            ...
            this.$api.post('/web/newsTemplate/list', data, r => {
                console.log(r)
        ...
        removeNewsTemplate(id){
            ...
            this.$api.post('web/newsTemplate/remove', data, r => {
                let arr =[]
