...
export default {
  ...
  methods: {
    ...
    getNews() {
      ...
      this.$api.post("web/news/list", data, r => {
    ...
    remove(id) {
      let data = { id };
      this.$api.post("web/news/remove", data, r => {
    ...
    batchRemove() {
      ...
      let arr = str.split(",");
      let data = { ids: str };
      this.$api.post("web/news/batchRemove", data, r => {
          var temp = [];
          var temparray = [];
    ...
    toTop(id) {
      let data = { id };
      this.$api.post("web/news/toTop", data, r => {
          this.dynamics = [];
          this.getNews();
      });
    },
    ...
    exportNewsInfo() {
      ...
      axios.post( this.$newsUrl + "/web/news/exportNewsInfo" , str , config)
        .then(res => {
    ...
    toMove(currentId, targetId, index1, index2) {
      ...
      this.$api.post("web/news/moveNewsOrder", data, r => {
          this.$util.hintHide(this);
