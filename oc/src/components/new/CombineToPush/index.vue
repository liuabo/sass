<template>
    <div class="CombineToPush">
        ...
        <div v-if="toPush.length" class="con">
            <div class="con_">
                <div  class="content">
                    <dl draggable="true" @dragenter="dragenter($event)" @dragend="dragend(item.id)"  :id="[item.id]"  class="clearfix" v-for="(item,index) in toPush" :key="item.id" :class="{first : index===0}">
