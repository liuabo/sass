...
export default {
  ...
  methods: {
    ...
    interval(boo, foo) {
      ...
      let url = this.$newsUrl + "/omweb/news/save";
      if (id != 0) {
        url = this.$newsUrl + "/omweb/news/update";
    ...
    //       parentId: id
    //     };
    //     this.$api.post("omweb/newsTags/getSubTags", data, r => {
    ...
    //     return;
    //   }
    //   this.$api.post("omweb/newsTags/getFirstLevelTags", null, r => {
    ...
    getNewsSource() {
      //获取信息来源
      this.$api.post("omweb/newsSource/getLists", null, r => {
        this.sourcesList = r.data;
      });
    },
    getLabelList() {
      this.$api.post("omweb/newsTags/list", null, r => {
    ...
    change() {
      ...
      if (id != 0) {
        ...
        if (_id != 0) {
          this.$api.get("omweb/newsTemplate/get/" + _id, null, r => {
            ...
            this.news.imgSrc = r.data.coverImage;
