...
export default {
    ...
    methods:{
        startDerma(id){
            ...
            this.list.forEach((item) => {
                if(item.id === id){
                    ...
                    this.$api.post(this.setUrl ? this.setUrl : '/omweb/newsSkins/enableSkins',data,r=>{
                        setTimeout(() => {
        ...
        getCurrentSkins(){
            this.$api.post(this.getUrl ? this.getUrl : '/omweb/newsSkins/getCurrentSkins',null,r=>{
